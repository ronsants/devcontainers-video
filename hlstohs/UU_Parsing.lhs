...
>  {-# LANGUAGE FunctionalDependencies, UndecidableInstances, RankNTypes #-}
>  module UU_Parsing
>  (
>  Result,
>  mapOnePars,
...
>  pLocate :: (Alternative a, SymParser a b, Symbol b, Sequence a) => [[b]] -> a [b]
>  pToks :: (Sequence a, SymParser a b, Symbol b) => [b] -> a [b]
>  list_of :: Sequence a => a b -> ([c],a ([b] -> [b]),d -> d)
>  usealg :: Sequence a => (b -> c,d) -> a b -> (d,a c,e -> e)
>  pMerged :: (Sequence a, Alternative a, Show (Exp b), SymParser a b, Symbol b, SplitParser a) => c -> (d,a (d -> d),c -> d -> e) -> a e
>  (<||>) :: (Sequence a, Alternative a) => (b,a (c -> c),d -> e -> f) -> (g,a (h -> h),f -> i -> j) -> ((b,g),a ((c,h) -> (c,h)),d -> (e,i) -> j)
>  pAnySym :: (Alternative a, SymParser a b, Symbol b) => [b] -> a b
>  pAny :: Alternative a => (b -> a c) -> [b] -> a c
>  pChainl :: (SplitParser a, SymParser a b, Symbol b, Show (Exp b), Sequence a, Alternative a) => a (c -> c -> c) -> a c -> a c
>  pChainl_ng :: (SplitParser a, SymParser a b, Symbol b, Show (Exp b), Sequence a, Alternative a) => a (c -> c -> c) -> a c -> a c
>  pChainl_gr :: (SplitParser a, SymParser a b, Symbol b, Show (Exp b), Sequence a, Alternative a) => a (c -> c -> c) -> a c -> a c
>  pChainr :: (SplitParser a, SymParser a b, Symbol b, Show (Exp b), Sequence a, Alternative a) => a (c -> c -> c) -> a c -> a c
>  pChainr_ng :: (SplitParser a, SymParser a b, Symbol b, Show (Exp b), Alternative a, Sequence a) => a (c -> c -> c) -> a c -> a c
>  pChainr_gr :: (SplitParser a, SymParser a b, Symbol b, Show (Exp b), Sequence a, Alternative a) => a (c -> c -> c) -> a c -> a c
>  pList1Sep :: (SplitParser a, SymParser a b, Symbol b, Show (Exp b), Sequence a, Alternative a) => a c -> a d -> a [d]
>  pList1Sep_ng :: (SplitParser a, SymParser a b, Symbol b, Show (Exp b), Sequence a, Alternative a) => a c -> a d -> a [d]
>  pList1Sep_gr :: (SplitParser a, SymParser a b, Symbol b, Show (Exp b), Sequence a, Alternative a) => a c -> a d -> a [d]
>  pListSep :: (SplitParser a, SymParser a b, Symbol b, Show (Exp b), Sequence a, Alternative a) => a c -> a d -> a [d]
>  pListSep_ng :: (SplitParser a, SymParser a b, Symbol b, Show (Exp b), Alternative a, Sequence a) => a c -> a d -> a [d]
>  pListSep_gr :: (SplitParser a, SymParser a b, Symbol b, Show (Exp b), Sequence a, Alternative a) => a c -> a d -> a [d]
>  pList1 :: (SymParser a b, Symbol b, Sequence a, Show (Exp b), SplitParser a, Alternative a) => a c -> a [c]
>  pList1_ng :: (SymParser a b, Symbol b, Sequence a, Show (Exp b), SplitParser a, Alternative a) => a c -> a [c]
>  pList1_gr :: (SymParser a b, Symbol b, Sequence a, Show (Exp b), SplitParser a, Alternative a) => a c -> a [c]
>  pList :: (SymParser a b, Symbol b, Show (Exp b), SplitParser a, Sequence a, Alternative a) => a c -> a [c]
>  pList_ng :: (SymParser a b, Symbol b, Show (Exp b), SplitParser a, Sequence a, Alternative a) => a c -> a [c]
>  pList_gr :: (SymParser a b, Symbol b, Show (Exp b), SplitParser a, Sequence a, Alternative a) => a c -> a [c]
>  list_alg :: (a -> [a] -> [a],[b])
>  pFoldr1Sep :: (SplitParser a, SymParser a b, Symbol b, Show (Exp b), Sequence a, Alternative a) => (c -> d -> d,d) -> a e -> a c -> a d
>  pFoldr1Sep_ng :: (SplitParser a, SymParser a b, Symbol b, Show (Exp b), Sequence a, Alternative a) => (c -> d -> d,d) -> a e -> a c -> a d
>  pFoldr1Sep_gr :: (SplitParser a, SymParser a b, Symbol b, Show (Exp b), Sequence a, Alternative a) => (c -> d -> d,d) -> a e -> a c -> a d
>  pFoldrSep :: (SplitParser a, SymParser a b, Symbol b, Show (Exp b), Sequence a, Alternative a) => (c -> d -> d,d) -> a e -> a c -> a d
>  pFoldrSep_ng :: (SplitParser a, SymParser a b, Symbol b, Show (Exp b), Alternative a, Sequence a) => (c -> d -> d,d) -> a e -> a c -> a d
>  pFoldrSep_gr :: (SplitParser a, SymParser a b, Symbol b, Show (Exp b), Sequence a, Alternative a) => (c -> d -> d,d) -> a e -> a c -> a d
>  pFoldr1 :: (SymParser a b, Symbol b, Sequence a, Show (Exp b), SplitParser a, Alternative a) => (c -> d -> d,d) -> a c -> a d
>  pFoldr1_ng :: (SymParser a b, Symbol b, Sequence a, Show (Exp b), SplitParser a, Alternative a) => (c -> d -> d,d) -> a c -> a d
>  pFoldr1_gr :: (SymParser a b, Symbol b, Sequence a, Show (Exp b), SplitParser a, Alternative a) => (c -> d -> d,d) -> a c -> a d
>  pFoldr :: (SymParser a b, Symbol b, Show (Exp b), SplitParser a, Sequence a, Alternative a) => (c -> d -> d,d) -> a c -> a d
>  pFoldr_gr :: (SymParser a b, Symbol b, Show (Exp b), SplitParser a, Sequence a, Alternative a) => (c -> d -> d,d) -> a c -> a d
...
>  orOneOneDescr :: (Ord (Exp a), Ord a, Eq a, Eq (SymbolR a)) => OneDescr b c a d -> OneDescr b c a d -> Bool -> OneDescr b c a d
